...
export const PostEngagement = ({
    like, reply, bookmark, share, hide = {}, addition, variant = "HORIZONTAL", sx
}: EngagementProps) => {
    ...
    return (
        <Stack
            ...
            <Stack sx={{
                ...
                {isVertical && !hide.bookmark && renderAction(
                    <BookmarkButton
