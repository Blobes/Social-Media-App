...
export const MediaRenderer = ({
    ...
    const { url, type, alt, dimensions, blurHash } = media;
    ...
    const isDesktop = useRender?.useMisc
        ? useRender.useMisc().isDesktop
        : true;
    ...
    return (
        <Box
            sx={{
                ...
                aspectRatio: dimensions?.aspectRatio ? `${dimensions.aspectRatio}` : "auto",
