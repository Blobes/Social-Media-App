...
export const CACHE_KEYS = {
  ...
  AUTH_TRANSIT_DATA: ["transit_data", "auth"],
  PASS_RESET_INIT_TRANSIT_DATA: ["transit_data", "password_reset_init"],
  PASS_RESET_FINALIZED_TRANSIT_DATA: [
    "transit_data",
    "password_reset_finalized",
  ],
